...
for type-name in <[
    Arr Assign Binary Block Call Cascade Chain Class Existence For Fun If Import Index Jump Key Literal Obj Parens Prop Return Splat Throw Try Unary Util While Var Yield
]>
    AST[type-name] = 
        (type): type-name
        constructor:
